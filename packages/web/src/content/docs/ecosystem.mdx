...
| [opencode-agent-memory](https://github.com/Ghilteras/opencode-agent-memory)                        | Persistent, self-editable memory blocks and a local semantic journal for OpenCode                  |
